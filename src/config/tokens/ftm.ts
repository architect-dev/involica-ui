export const ftmSymbols: Record<string, string> = {
...
export const ftmStables: Record<string, boolean> = {
	...
	'0x82f0B8B456c1A451378467398982d4834b6829c1': true,
}

export const ftmDecimals: Record<string, number> = {
