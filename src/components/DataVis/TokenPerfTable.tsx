...
const TokenRow: React.FC<{
	...
	censorable?: boolean
	onClick?: () => void
}> = ({ data, isTokenIn = false, hasOuts = false, isAggregate = false, highlighted = false, censorable = false, onClick }) => {
	return (
...
}> = ({ tokensIn, tokensOut, isAggregate, highlightedTokens = [], censorable = false, onTokenInClick, onTokenOutClick }) => {
