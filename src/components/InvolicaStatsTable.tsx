	...
	return (
		<Card title='Involica Stats' padding='24px'>
			<CellRow>
				<CellCol>
					<Text small italic>
						Involica and all her combined users' stats:
					</Text>
				...
				<CellCol>
					<ClickableCol highlighted={userTotalPerformanceSelected} onClick={handleShowUserTotalPerformance}>
						...
						<DataRow className='row' px='6px' t='Current Users Value:' v={involicaStats?.totalOutFull?.current?.usdDisplay} />
						<DataRow className='row' px='6px' t='Total PnL of Involica:' v={<PerfIndicator {...involicaStats?.totalValueChange} gap='6px' />} />
					</ClickableCol>
				</CellCol>
			</CellRow>
		</Card>
