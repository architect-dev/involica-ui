		...
		<ModalContentContainer alignItems='flex-start' minWidth='300px' maxWidth='350px' gap='12px'>
			...
			{!unpauseOnly && (
				<>
					...
					<SummitButton isLoading={exitPending} onClick={onExitPosition} activeText='Exit Position' loadingText='Exiting' variant='danger' />
			...
			<RowCenter gap='18px'>
				...
				{unpauseOnly && (
					<SummitButton isLoading={pausePending} onClick={handleTogglePaused} activeText='Unpause Position' loadingText='Unpausing' padding='0 18px' />
				)}
			</RowCenter>
