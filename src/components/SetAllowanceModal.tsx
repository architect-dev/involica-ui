...
export const SetAllowanceModal: React.FC<{
  ...
  const [dcasCountInvalidReason, setDcasCountInvalidReason] = useState<string | null>(
    amountDCAInvalid ? 'Your current DCA amount is 0' : null,
  )
