...
export const TopUpFundsModalContent: React.FC<{
	...
	const [fundingInvalidReason, setFundingInvalidReason] = useState<Nullable<string>>(null)
	...
	const topUpCoveredDcasCount = useMemo(() => {
		if (fundingAmount == null || fundingAmount === '' || fundingAmount === '0' || isNaN(parseFloat(fundingAmount))) return '-'
		if (maxTxPrice == null || maxTxPrice === '' || maxTxPrice === '0') return '-'
	...
	return (
		<ModalContentContainer alignItems='flex-start' minWidth='300px' maxWidth='400px' gap='12px'>
			...
			{fundingAmount != null && fundingAmount !== '0' && <DataRow t='DCAs covered by Top Up:' v={topUpCoveredDcasCount} />}
...
export const TopUpFundsModal: React.FC = () => {
	...
	return <SummitPopUp open={topUpModalOpen} callOnDismiss={hideTopUpModal} modal popUpTitle='Top Up Funds' popUpContent={<TopUpFundsModalContent />} />
}
