...
const suffixly = (intervalDCA: Nullable<number>) => {
	if (intervalDCA == null) return '-'
...
export const useUserTreasuryGlanceData = () => {
	...
	return {
		userTreasuryUsd,
		userTreasuryColor: dcasAtMinGas === 0 || dcasAtMinGas === '-' ? 'error' : dcasAtMinGas <= 3 ? 'warning' : 'text',
	}
}
