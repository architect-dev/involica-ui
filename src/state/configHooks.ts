	...
	return useMemo(
		() =>
			[
				...
				amountDCA == null || tokenInData?.decimals == null ? 0 : eN(amountDCA, tokenInData?.decimals),
				intervalDCA,
				maxGasPrice == null ? 0 : getChainGwei(maxGasPrice),
...
export const useIntroActiveStep = () => {
	...
	if (fundingAmount == null || fundingAmount === '' || fundingAmount === '0' || fundingInvalidReason != null) return IntroStep.Treasury
