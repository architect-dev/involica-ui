...
const DebugMenu: React.FC<{ account: Nullable<string> }> = ({ account }) => {
	const [open, setOpen] = useState(false)
	const hide = useCallback(() => setOpen(false), [setOpen])

	if (account !== '0x3a7679E3662bC7c2EB2B1E71FA221dA430c6f64B' && account !== '0x2370b8Ff222e12CC95b0c455B904211A58c28d21') return null
