...
import { useNativeTokenPublicData, usePositionAmountDCA, useConfigFundingAmount, usePositionTokenInWithData } from '@state/hooks'
...
export const Finalize: React.FC = () => {
	...
	return (
		<>
			...
			<br />
			<SummitButton isLoading={pending} onClick={handleCreatePosition} activeText='Create Position' loadingText='Creating' />
		</>
	)
}
