...
export const ApproveIn: React.FC = () => {
  ...
  const approvalAmount = useMemo(() => {
    ...
    return bnDisplay(
      bn(eN(amountDCA, tokenInData?.decimals)).times(dcasCount === '' ? '0' : parseInt(dcasCount)),
  ...
  return (
    <>
      <IntroText small>
        ...
        <br />
        <i>
          Enter the amount of DCA transactions you want to run, and then approve your <b>{tokenInData?.symbol}</b>{' '}
          spends:
          <br />
          <br />
