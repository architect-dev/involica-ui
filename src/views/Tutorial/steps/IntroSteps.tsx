	...
	return (
		<>
			...
			<IntroText small italic>
				...
				<br />
				<br />
				Involica is dead simple insulation against market volitility. You create a DCA Position, one input token and multiple out tokens, set how often, and how
				much to DCA each time.
				<br />
				<br />
				Then for each DCA, Involica pulls the funds from your wallet, performs the necessary swaps (0.1% swap fee), and sends your new portfolio back in a
				single transaction. Your funds always remain in your wallet, safe and secure.
				<br />
				<br />
			...
			<br />
			<br />
			<SummitButton onClick={getStarted} activeText='I Understand, Get Started' />
			<ConfigPreview key='' />
			<br />
			<br />
			<br />
			<StepsRowWrap>
				{[IntroStep.TokenIn, IntroStep.Amount, IntroStep.Outs, IntroStep.Interval, IntroStep.Approve, IntroStep.Treasury, IntroStep.Finalize].map((step) => (
					<Card halfWidth={stepHalfWidth[step]} key={step} expanded={introStep >= step} title={stepTitle[step]}>
