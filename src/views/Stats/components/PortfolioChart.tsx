...
import { Chart as ChartJS, CategoryScale, TimeScale, LinearScale, PointElement, LineElement, Title, Tooltip, Legend, Filler } from 'chart.js'
...
const PortfolioChart: React.FC = () => {
	...
	const chartData = useInvolicaDCAChartData(dataOption === ChartDataOption.User, dataOption === ChartDataOption.User ? focusedToken : null, false)
					...
					tooltip: {
						...
						callbacks: {
							...
							footer: (tooltipItems) => {
								...
								if (dcasCountChart) {
									const dcas = (datasets[2].data[dataIndex] as number) - (dataIndex === 0 ? 0 : (datasets[2].data[dataIndex - 1] as number))
									return `${dcas} DCAs`
								}
